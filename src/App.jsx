...
function ImmersivePreloader({ onComplete }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden pointer-events-none select-none font-mono text-white">
      ...
      <div
        className={`shutter-panel-left absolute top-0 bottom-0 left-0 w-1/2 bg-[#0a0e17] z-40 ${
      ...
      <div
        className={`shutter-panel-right absolute top-0 bottom-0 right-0 w-1/2 bg-[#0a0e17] z-40 ${
